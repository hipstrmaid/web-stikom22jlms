            ...
            <div class="bg-white text-sm border border-gray-200 border-t-0 dark:border-gray-900 dark:bg-gray-800">
                <ul class="grid w-full gap-2 mb-4 p-5">
                    <form action="{{ route('admin.update', ['admin' => $admin->id]) }}" method="POST"
                        ...
                        @csrf
                        @method('PUT')
                        <div class="grid grid-cols-1 xl:grid-cols-5 gap-2 xl:gap-4 text-right">
                            ...
                            @if ($admin->foto)
                                ...
                                <div class="col-span-1 xl:col-span-4">
                                    <img class="w-20 h-20 rounded-full" src="{{ Storage::url($admin->foto) }}"
                                        alt="Rounded avatar">
                            ...
                            <div class="col-span-1 xl:col-span-4">
                                <input type="text" id="nama" name="nama" value="{{ old('nama', $admin->nama) }}"
