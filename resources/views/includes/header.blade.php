<nav
    class="md:ml-64 bg-brown-bg text-white drop-shadow-md px-4 py-2.5 dark:bg-gray-800 sm:dark:bg-gray-900 dark:border-gray-700 fixed left-0 right-0 top-0 z-50">
