        <!-- Sidebar -->
        <aside
            class="fixed text-gray-900 dark:text-white top-0 left-0 bg-gray-50 dark:bg-gray-800 z-40 w-64 h-screen pt-14 transition-transform -translate-x-full border-r border-gray-200 md:translate-x-0 dark:bg-gray-800 dark:border-gray-700"
                ...
                <ul class="space-y-1">
                    ...
                    @auth
                        ...
                        @if (Auth::user()->role_id == 4)
                            <li>
                                <button type="button"
                                    class="flex items-center p-2 px-4 w-full text-base font-medium  rounded-lg transition duration-75 group hover:bg-gray-100  dark:hover:bg-gray-700"
