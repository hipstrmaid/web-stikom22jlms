        <!-- Sidebar -->
        <aside
            class="fixed top-0 left-0 bg-gray-100 dark:bg-gray-800 z-40 w-64 h-screen pt-14 transition-transform -translate-x-full border-r border-gray-200 md:translate-x-0 dark:bg-gray-800 dark:border-gray-700"
