                ...
                <ul class="space-y-1">
                        ...
                        <ul id="dropdown-pages" class="hidden py-2 space-y-2">
                            <li>
                                <a href="/matkul/matkul-saya"
                                    class="flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Mata
                                    Kuliah Saya</a>
                            </li>
                            <li>
                                <a href="#"
                    ...
                    <li>
                        <button type="button"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" height="1em"
                                viewBox="0 0 640 512">
                                <path
